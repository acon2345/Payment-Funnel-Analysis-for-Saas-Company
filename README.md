...
### Results:
After examining the data, we were able to find that over 15% of subscriptions encountered an error somewhere in the online payment process. Some of these were able to continue on and complete the process but others not. Therefore, just encountering the error impacts the successful completion of the process.
